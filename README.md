...
dotnet anchorgen -i target/idl/hackillinois-game.json -o target/idl/HackillinoisGame.cs
```

(Replace hackillinois-game with the name of your program)
...
useEffect(() => {
    ...
    const [pda] = PublicKey.findProgramAddressSync(
        ...
        publicKey.toBuffer()],
        new PublicKey(HackillinoisGame_PROGRAM_ID)
      );
    try {
