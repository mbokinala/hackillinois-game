...
import { HackillinoisGame } from "../target/types/hackillinois_game";

describe("hackillinois-game", () => {

  const provider = anchor.AnchorProvider.env()
  anchor.setProvider(provider)
  const program = anchor.workspace.HackillinoisGame as Program<HackillinoisGame>;
