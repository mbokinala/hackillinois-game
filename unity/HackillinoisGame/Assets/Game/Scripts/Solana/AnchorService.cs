...
public class AnchorService : MonoBehaviour
{
    ...
    private HackillinoisGameClient anchorClient;
    ...
    private async void OnLogin(Account account)
    {
        ...
        anchorClient = new HackillinoisGameClient(Web3.Rpc, Web3.WsRpc, AnchorProgramIdPubKey);
    ...
    public async Task InitAccounts(bool useSession)
    {
        ...
        var initTx = HackillinoisGameProgram.InitPlayer(accounts, levelSeed, AnchorProgramIdPubKey);
        tx.Add(initTx);
    ...
    public async void ChopTree(bool useSession, Action onSuccess)
    {
        ...
        if (useSession)
        {
            ...
            var chopInstruction = HackillinoisGameProgram.ChopTree(chopTreeAccounts, levelSeed, transactionCounter, AnchorProgramIdPubKey);
